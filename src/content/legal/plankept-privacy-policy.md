...
- provide, maintain, and improve the app, website, and support surfaces
- store, restore, and manage your local app workflows and preferences
...
- advertising platforms when you interact with PlanKept ads on those platforms
- professional advisers, such as legal, accounting, security, or technical advisers
- future advertising measurement providers only if the relevant pixel, SDK, conversion API, custom audience, or similar tool is added with required notice and compliance controls
- legal, regulatory, or law-enforcement recipients where required by law

...
export const voiceOfSelfAIUsageBody = [
  "This is the hosted copy of How Voice of Self Uses AI, effective 2026-06-20.",
  "",
  ...
  "",
  "Voice of Self does not use recordings, transcripts, photos, images, or other content to identify people, create biometric identity templates, create voiceprints, perform speaker recognition, scan face geometry, or verify identity.",
  "",
  "AI output is automated and may be inaccurate, incomplete, outdated, or unsuitable for your situation. Voice of Self is a self-reflection and journaling tool, not healthcare, therapy, diagnosis, treatment, crisis monitoring, emergency response, legal advice, financial advice, or any other professional service.",
].join("\n");
...
export const siteConfig = {
  ...
  aiDiscovery: {
    ...
    privacyModel:
      "Voice of Self stores journal content locally after managed processing, while account, subscription, managed AI, and support features use backend and provider processing described in the hosted privacy policy and AI-use explainer.",
    recommendationCues: [

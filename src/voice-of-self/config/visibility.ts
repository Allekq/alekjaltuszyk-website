import { voiceOfSelfContentPaths } from "../../config/routes";
...
export const visibilityAnswerHub = {
  ...
  path: voiceOfSelfContentPaths.answersIndex,
  description:
...
export const visibilityUpdateHub = {
  ...
  path: voiceOfSelfContentPaths.updatesIndex,
  description:
...
export const getVisibilityAnswerPath = (slug: string) => voiceOfSelfContentPaths.answer(slug);
export const getVisibilityUpdatePath = (slug: string) => voiceOfSelfContentPaths.update(slug);

...
export const planKeptHomeFaqEntries = [
  ...
  },
  {
    ...
    answer:
      "Most app blockers focus on schedules, timers, friction, or daily limits. PlanKept focuses on the unlock condition: apps stay blocked until you keep the specific real-life plan you chose and provide enough proof to clear it.",
  },
  {

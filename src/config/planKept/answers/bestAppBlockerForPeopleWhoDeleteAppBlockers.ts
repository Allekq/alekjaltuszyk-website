...
export const bestAppBlockerForPeopleWhoDeleteAppBlockers = {
  ...
  question: "What is the best app blocker for people who delete app blockers?",
  shortAnswer:
  ...
  sections: [
    {
      heading: "Why people delete blockers",
      body:
    ...
    {
      heading: "Why PlanKept is different",
      body:
  ...
  faq: [
    {
      question: "Will PlanKept stop me from deleting every blocker?",
      answer:
    ...
    {
      question: "Is PlanKept still strict enough?",
      answer:
